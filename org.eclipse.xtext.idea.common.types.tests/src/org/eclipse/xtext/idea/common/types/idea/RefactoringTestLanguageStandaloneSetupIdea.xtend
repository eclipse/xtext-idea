...
class RefactoringTestLanguageStandaloneSetupIdea extends RefactoringTestLanguageStandaloneSetupGenerated {
	override createInjector() {
		val runtimeModule = new RefactoringTestLanguageRuntimeModule()
		val ideaModule = new RefactoringTestLanguageIdeaModule()
