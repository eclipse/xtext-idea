 ...
 */
class RefactoringTestLanguageIdeSetup extends RefactoringTestLanguageStandaloneSetup {

	override createInjector() {
		Guice.createInjector(new RefactoringTestLanguageRuntimeModule, new RefactoringTestLanguageIdeModule)
	}
}
