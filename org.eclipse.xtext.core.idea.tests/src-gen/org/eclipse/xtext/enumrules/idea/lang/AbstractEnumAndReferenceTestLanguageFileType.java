...
public class AbstractEnumAndReferenceTestLanguageFileType extends LanguageFileType {

	@NonNls 
	public static final String DEFAULT_EXTENSION = "enumandreferencetestlanguage";

	protected AbstractEnumAndReferenceTestLanguageFileType(final Language language) {
		super(language);
	}
