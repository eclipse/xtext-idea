...
public class AbstractContextFinderTestLanguageFileType extends LanguageFileType {

	@NonNls 
	public static final String DEFAULT_EXTENSION = "contextfindertestlanguage";

	protected AbstractContextFinderTestLanguageFileType(final Language language) {
		super(language);
	}
