...
public class InheritanceTest2LanguageElementTypeProvider implements IElementTypeProvider {

	public static final IFileElementType FILE_TYPE = new XtextFileElementType<XtextFileStub<InheritanceTest2LanguageFileImpl>>(InheritanceTest2LanguageLanguage.INSTANCE);
	...
	private static final InheritanceTest2LanguageGrammarAccess GRAMMAR_ACCESS = InheritanceTest2LanguageLanguage.INSTANCE.getInstance(InheritanceTest2LanguageGrammarAccess.class);

	private static class ModelFactory {
		public static IGrammarAwareElementType createModelElementType() {
			return new IGrammarAwareElementType("Model_ELEMENT_TYPE", InheritanceTest2LanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getModelRule());
		}
		public static IGrammarAwareElementType createModel_GroupElementType() {
			return new IGrammarAwareElementType("Model_Group_ELEMENT_TYPE", InheritanceTest2LanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getModelAccess().getGroup());
		}
		public static IGrammarAwareElementType createModel_ModelKeyword_0ElementType() {
			return new IGrammarAwareElementType("Model_ModelKeyword_0_ELEMENT_TYPE", InheritanceTest2LanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getModelAccess().getModelKeyword_0());
		}
		public static IGrammarAwareElementType createModel_NameAssignment_1ElementType() {
			return new IGrammarAwareElementType("Model_NameAssignment_1_ELEMENT_TYPE", InheritanceTest2LanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getModelAccess().getNameAssignment_1());
		}
		public static IGrammarAwareElementType createModel_NameIDTerminalRuleCall_1_0ElementType() {
			return new IGrammarAwareElementType("Model_NameIDTerminalRuleCall_1_0_ELEMENT_TYPE", InheritanceTest2LanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getModelAccess().getNameIDTerminalRuleCall_1_0());
		}
		public static IGrammarAwareElementType createModel_LeftCurlyBracketKeyword_2ElementType() {
			return new IGrammarAwareElementType("Model_LeftCurlyBracketKeyword_2_ELEMENT_TYPE", InheritanceTest2LanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getModelAccess().getLeftCurlyBracketKeyword_2());
		}
		public static IGrammarAwareElementType createModel_ElementsAssignment_3ElementType() {
			return new IGrammarAwareElementType("Model_ElementsAssignment_3_ELEMENT_TYPE", InheritanceTest2LanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getModelAccess().getElementsAssignment_3());
		}
		public static IGrammarAwareElementType createModel_ElementsElementParserRuleCall_3_0ElementType() {
			return new IGrammarAwareElementType("Model_ElementsElementParserRuleCall_3_0_ELEMENT_TYPE", InheritanceTest2LanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getModelAccess().getElementsElementParserRuleCall_3_0());
		}
		public static IGrammarAwareElementType createModel_IdsAssignment_4ElementType() {
			return new IGrammarAwareElementType("Model_IdsAssignment_4_ELEMENT_TYPE", InheritanceTest2LanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getModelAccess().getIdsAssignment_4());
		}
		public static IGrammarAwareElementType createModel_IdsFQNParserRuleCall_4_0ElementType() {
			return new IGrammarAwareElementType("Model_IdsFQNParserRuleCall_4_0_ELEMENT_TYPE", InheritanceTest2LanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getModelAccess().getIdsFQNParserRuleCall_4_0());
		}
		public static IGrammarAwareElementType createModel_RightCurlyBracketKeyword_5ElementType() {
			return new IGrammarAwareElementType("Model_RightCurlyBracketKeyword_5_ELEMENT_TYPE", InheritanceTest2LanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getModelAccess().getRightCurlyBracketKeyword_5());
		}
	}
	...
	public static final IGrammarAwareElementType Model_IdsAssignment_4_ELEMENT_TYPE = associate(ModelFactory.createModel_IdsAssignment_4ElementType());

	public static final IGrammarAwareElementType Model_IdsFQNParserRuleCall_4_0_ELEMENT_TYPE = associate(ModelFactory.createModel_IdsFQNParserRuleCall_4_0ElementType());

	public static final IGrammarAwareElementType Model_RightCurlyBracketKeyword_5_ELEMENT_TYPE = associate(ModelFactory.createModel_RightCurlyBracketKeyword_5ElementType());

	private static class ElementFactory {
		public static IGrammarAwareElementType createElementElementType() {
			return new IGrammarAwareElementType("Element_ELEMENT_TYPE", InheritanceTest2LanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getElementRule());
		}
		public static IGrammarAwareElementType createElement_GroupElementType() {
			return new IGrammarAwareElementType("Element_Group_ELEMENT_TYPE", InheritanceTest2LanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getElementAccess().getGroup());
		}
		public static IGrammarAwareElementType createElement_ElementKeyword_0ElementType() {
			return new IGrammarAwareElementType("Element_ElementKeyword_0_ELEMENT_TYPE", InheritanceTest2LanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getElementAccess().getElementKeyword_0());
		}
		public static IGrammarAwareElementType createElement_NameAssignment_1ElementType() {
			return new IGrammarAwareElementType("Element_NameAssignment_1_ELEMENT_TYPE", InheritanceTest2LanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getElementAccess().getNameAssignment_1());
		}
		public static IGrammarAwareElementType createElement_NameIDTerminalRuleCall_1_0ElementType() {
			return new IGrammarAwareElementType("Element_NameIDTerminalRuleCall_1_0_ELEMENT_TYPE", InheritanceTest2LanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getElementAccess().getNameIDTerminalRuleCall_1_0());
		}
	}
	...
	private static class FQNFactory {
		public static IGrammarAwareElementType createFQNElementType() {
			return new IGrammarAwareElementType("FQN_ELEMENT_TYPE", InheritanceTest2LanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getFQNRule());
		}
		public static IGrammarAwareElementType createFQN_GroupElementType() {
			return new IGrammarAwareElementType("FQN_Group_ELEMENT_TYPE", InheritanceTest2LanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getFQNAccess().getGroup());
		}
		public static IGrammarAwareElementType createFQN_IDTerminalRuleCall_0ElementType() {
			return new IGrammarAwareElementType("FQN_IDTerminalRuleCall_0_ELEMENT_TYPE", InheritanceTest2LanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getFQNAccess().getIDTerminalRuleCall_0());
		}
		public static IGrammarAwareElementType createFQN_Group_1ElementType() {
			return new IGrammarAwareElementType("FQN_Group_1_ELEMENT_TYPE", InheritanceTest2LanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getFQNAccess().getGroup_1());
		}
		public static IGrammarAwareElementType createFQN_FullStopKeyword_1_0ElementType() {
			return new IGrammarAwareElementType("FQN_FullStopKeyword_1_0_ELEMENT_TYPE", InheritanceTest2LanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getFQNAccess().getFullStopKeyword_1_0());
		}
		public static IGrammarAwareElementType createFQN_IDTerminalRuleCall_1_1ElementType() {
			return new IGrammarAwareElementType("FQN_IDTerminalRuleCall_1_1_ELEMENT_TYPE", InheritanceTest2LanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getFQNAccess().getIDTerminalRuleCall_1_1());
		}
	}
	...
	public IGrammarAwareElementType getModel_IdsAssignment_4ElementType() {
		return Model_IdsAssignment_4_ELEMENT_TYPE;
	}

	public IGrammarAwareElementType getModel_IdsFQNParserRuleCall_4_0ElementType() {
		return Model_IdsFQNParserRuleCall_4_0_ELEMENT_TYPE;
	}

	public IGrammarAwareElementType getModel_RightCurlyBracketKeyword_5ElementType() {
		return Model_RightCurlyBracketKeyword_5_ELEMENT_TYPE;
	}
