 ...
 * @generated
 */
public class SDomainPackageImpl extends EPackageImpl implements SDomainPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.eclipse.xtext.idea.sdomain.sDomain.SDomainPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private SDomainPackageImpl()
  {
    super(eNS_URI, SDomainFactory.eINSTANCE);
  }
   ...
   * 
   * <p>This method is used to initialize {@link SDomainPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static SDomainPackage init()
  {
    if (isInited) return (SDomainPackage)EPackage.Registry.INSTANCE.getEPackage(SDomainPackage.eNS_URI);

    // Obtain or create and register package
    SDomainPackageImpl theSDomainPackage = (SDomainPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof SDomainPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new SDomainPackageImpl());

    isInited = true;

    // Create package meta-data objects
    theSDomainPackage.createPackageContents();

    // Initialize created meta-data
    theSDomainPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theSDomainPackage.freeze();

  
    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(SDomainPackage.eNS_URI, theSDomainPackage);
    return theSDomainPackage;
  }
   ...
   * @generated
   */
  public SDomainFactory getSDomainFactory()
  {
    return (SDomainFactory)getEFactoryInstance();
  }
