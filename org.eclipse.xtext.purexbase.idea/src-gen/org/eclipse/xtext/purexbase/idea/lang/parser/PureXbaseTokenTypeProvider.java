...
public class PureXbaseTokenTypeProvider implements TokenTypeProvider {
	...
	private static final TokenSet WHITESPACE_TOKENS = TokenSet.create(tokenTypes[PsiInternalPureXbaseParser.RULE_WS]);
	private static final TokenSet COMMENT_TOKENS = TokenSet.create(tokenTypes[PsiInternalPureXbaseParser.RULE_SL_COMMENT], tokenTypes[PsiInternalPureXbaseParser.RULE_ML_COMMENT]);
	private static final TokenSet STRING_TOKENS = TokenSet.create(tokenTypes[PsiInternalPureXbaseParser.RULE_STRING]);
